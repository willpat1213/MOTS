...
from .overlap import OverlapTextDataset, SynthOverlapTextDataset, SceneSynthOverlapTextDataset
from .total_text import TotalTextDataset
from .textseg import TextSegDataset
from .coco_text import CocoTextDataset
from .worldart import WorldArtDataset
from .signatr6k import SignaTR6K
...
<<<<<<< HEAD
    'NYUDataset', 'OverlapTextDataset', 'SynthOverlapTextDataset', 'TotalTextDataset',
    'TextSegDataset', 'CocoTextDataset', 'WorldArtDataset', 'SceneSynthOverlapTextDataset',
    'SignaTR6K'
=======
