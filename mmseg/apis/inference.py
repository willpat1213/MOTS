...
from .utils import ImageType, _preprare_data, _preprare_data_with_d
...
def inference_model_with_d(model: BaseSegmentor,
                           img: ImageType,
                           depth: ImageType) -> Union[SegDataSample, SampleList]:
    data, is_batch = _preprare_data_with_d(img, depth, model)
